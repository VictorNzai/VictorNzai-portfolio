...
const Logo = ({ isMobile = false }) => (
    ...
    >
        ...
        >
            ...
            >
                <span className="hidden sm:inline">{config.developer.name} | Nzai</span>
...
const ContactButton = ({ isMobile = false, onLinkClick }) => (
    <motion.div
        ...
        onClick={onLinkClick}
    >
        <Link href={"https://github.com/VictorNzai/VictorNzai-Portfolio"} target='_blank' className={isMobile ? 'w-full' : ''}>
